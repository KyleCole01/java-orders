...
import com.example.javaorders.repo.AgentRepo
import com.example.javaorders.repo.CustomerRepo
import com.example.javaorders.repo.OrderRepo
...
@Transactional
@Component
open class SeedData(private val custrepos: CustomerRepo, private val agentrepos: AgentRepo, private val ordersrepos: OrderRepo) : CommandLineRunner {
